...
class QuillHtmlWidget extends StatefulWidget {
  const QuillHtmlWidget({super.key});

  @override
  State<QuillHtmlWidget> createState() => QuillHtmlWidgetState();
}

class QuillHtmlWidgetState extends State<QuillHtmlWidget> {
        ...
        body: Column(
          children: [
            ToolBar(
              ...
              activeIconColor: AppColor.blueColor,
  ...
  void getHtmlText() async {
    String? htmlText = await controller.getSelectedHtmlText();
    debugPrint(htmlText);
  }
